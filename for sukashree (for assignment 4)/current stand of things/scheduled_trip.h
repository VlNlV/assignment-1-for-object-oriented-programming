...
class NetworkScheduledTrip {
  ...
  NetworkScheduledTrip(const Trip& ganzetripobjekt, const std::vector<StopTime>& stoptimesvector);  // konstruktur fürs erstellen NetworkScheduledTrip objekts (mit übergabe einer tripID und der liste der stoptime objekte)
