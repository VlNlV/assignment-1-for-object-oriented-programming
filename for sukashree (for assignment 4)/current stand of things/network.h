...
public:
    ...
    std::multimap<std::string, std::string> stopzutripsmap;
    std::multimap<std::string, std::string> stopszustationsmap;
    std::multimap<std::string, std::string> tripzustopsmap;
    std::multimap<std::string, StopTime> tripzustoptimes;
    std::unordered_map<std::string, std::shared_ptr<NetworkScheduledTrip>> tripsdiescheduledsind;
