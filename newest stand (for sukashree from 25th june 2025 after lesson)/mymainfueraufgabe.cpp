...
int main() {
    ...
    bht::Network beispiel(verzeichnismitdendateien);     // objekt bekommt zugriff auf dateien 
    ...
    */
    std::string startHaltestelle = "de:12054:900230999";
    std::string zielHaltestelle = "de:13071:12353";
